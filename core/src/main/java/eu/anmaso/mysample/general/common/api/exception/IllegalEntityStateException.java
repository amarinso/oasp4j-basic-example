package eu.anmaso.mysample.general.common.api.exception;

import eu.anmaso.mysample.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link eu.anmaso.mysample.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the mysampleEntity entity.
