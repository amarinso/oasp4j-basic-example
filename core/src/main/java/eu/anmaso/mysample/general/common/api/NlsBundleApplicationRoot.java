package eu.anmaso.mysample.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see eu.anmaso.mysample.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see eu.anmaso.mysample.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
